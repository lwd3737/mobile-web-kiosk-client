...
//action type
const GET_PARTNER_DATA = 'partner/GET_PARTNER_DATA';
const GET_PARTNER_DATA_SUCCESS = 'partner/GET_PARTNER_DATA_SUCCESS';
const GET_PARTNER_DATA_FAILED = 'partner/GET_PARTNER_DATA_FAILED';
...
//redux thunk
export const getPartnerDataThunk = createAsyncThunk(GET_PARTNER_DATA, partnerApi.getPartnerData);
...
function handlePartnerData(state, action){
    switch(action.type){
        case GET_PARTNER_DATA_SUCCESS:
            const { id, name, homeThumbnails } = action.payload;
