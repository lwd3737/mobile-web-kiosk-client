...
function PurchasePage() {
  ...
  return (
    <S.PurchasePage>
      <Switch>
        <Route exact path={`${basePath}/rooms`}>
          <RoomSelectionPage />
        </Route>
        <Route exact path={`${basePath}/rooms/:roomId/seats`}>
          <SeatSelectionPage />
        </Route>
        <Route exact path={`${basePath}/rooms/:roomId/seats/:seatId/useticket`}>
          <UseTicketSelectionPage />
        </Route>
        <Route
          exact
          path={`${basePath}/rooms/:roomId/seats/:seatId/useticket/:useticketId/payment`}
        >
          <PaymentPage />
        </Route>
        <Route exact path={`${basePath}/payment/completion`}>
